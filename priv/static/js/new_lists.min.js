...
(function(){document.addEventListener("DOMContentLoaded",function(){listPage.initializeSelectElement();document.addEventListener("click",function(d){listPage.closeToastsOnClick(d)},{passive:!0});var a=document.getElementById("add-to-list-btn"),c=document.getElementById("add-to-new-list-btn"),b=document.getElementById("new-list-name");a.addEventListener("click",listPage.addAlbumToExistingList);c.addEventListener("click",listPage.addAlbumToNewList);b.addEventListener("keyup",function(d){13===d.keyCode&&
