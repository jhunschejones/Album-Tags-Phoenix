function truncate(a,c){if(-1==a.lastIndexOf(" "))return a.substr(0,c-9)+"...";a=a.substr(0,c-1);return a.substr(0,a.lastIndexOf(" ")).replace(/(^[,\s]+)|([,\s]+$)/g,"")+"..."}
