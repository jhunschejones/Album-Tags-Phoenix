defmodule AlbumTagsWeb.Router do
  ...
  scope "/migrate", AlbumTagsWeb do
    pipe_through :api

    post "/album", MigrationController, :create_album
    post "/tag", MigrationController, :add_tag
    post "/connection", MigrationController, :add_connection
    post "/list", MigrationController, :create_list
  end
